...
public class Controller {
    ...
    public Controller (){
        ...
        String menu = "Bienvenido al programa de Algoritmos de Ordenamiento y Selecci�n\n"
        + 	"Seleccione una opcion a Continuaci�n:\n"
        		...
        		+ "5. Retornar un vector con todos los numeros primos en la matriz ordenados descendentemente (Selecci�n)\n"
        		+ "6. Retornar un arreglo con los primeros n multiplos de x ordenados ascendentemente (Inserci�n)\n";
		...
		break;
      		...
      		default:
      			v.mostrarInformacion("Opci�n Invalida");
      			break;
      		}
		} catch (Exception e) {
			// TODO: handle exception
			v.mostrarInformacion("Error: Opci�n Invalida");
		}
